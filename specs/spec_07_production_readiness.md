...
| Tests | 146 XCTest methods in the current test target after FluidAudio Models UI coverage |
...
The current repository contains 146 XCTest methods distributed across state, audio, transcription, injection, overlay, Settings, LLM, onboarding, package-import, and baseline tests. The complete test target is the primary regression gate. [22]
